...
class TextMateTheme
  ...
  buildGlobalSettingsRulesets: (settings) ->
    @rulesets.push
      selector: 'via-text-editor'
      properties:
        'background-color': '@syntax-background-color'
        'color': '@syntax-text-color'

    @rulesets.push
      selector: 'via-text-editor .gutter'
      properties:
        'background-color': '@syntax-gutter-background-color'
        'color': '@syntax-gutter-text-color'

    @rulesets.push
      selector: 'via-text-editor .gutter .line-number.cursor-line'
      properties:
        'background-color': '@syntax-gutter-background-color-selected'
        'color': '@syntax-gutter-text-color-selected'

    @rulesets.push
      selector: 'via-text-editor .gutter .line-number.cursor-line-no-selection'
      properties:
        'color': '@syntax-gutter-text-color-selected'

    @rulesets.push
      selector: 'via-text-editor .wrap-guide'
      properties:
        'color': '@syntax-wrap-guide-color'

    @rulesets.push
      selector: 'via-text-editor .indent-guide'
      properties:
        'color': '@syntax-indent-guide-color'

    @rulesets.push
      selector: 'via-text-editor .invisible-character'
      properties:
        'color': '@syntax-invisible-character-color'

    @rulesets.push
      selector: 'via-text-editor.is-focused .cursor'
      properties:
        'border-color': '@syntax-cursor-color'

    @rulesets.push
      selector: 'via-text-editor.is-focused .selection .region'
      properties:
        'background-color': '@syntax-selection-color'

    @rulesets.push
      selector: 'via-text-editor.is-focused .line-number.cursor-line-no-selection,
                 via-text-editor.is-focused .line.cursor-line'
      properties:
